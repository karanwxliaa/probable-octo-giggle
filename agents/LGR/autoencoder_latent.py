...
class AutoEncoderLatent(Replayer):
    ...
    def __init__(self, latent_size, classes,
        ...
        self.fcE = MLP(input_size=latent_size, output_size=fc_units, layers=fc_layers-1,
        ...
        # -fully connected hidden layers
        self.fcD = MLP(input_size=fc_units, output_size=latent_size, layers=fc_layers-1,
    ...
    def name(self):
        ...
        hid_label = "{}{}-".format("i", self.latent_size) if self.fc_layers==1 else ""
    ...
    def loss_function(self, recon_x, x, y_hat=None, y_target=None, scores=None, mu=None, logvar=None):
        ...
        if scores is not None:
            ...
            distilL = lgr_utils.loss_fn_kd(scores=y_hat[:, :n_classes_to_consider], target_scores=scores, T=self.KD_temp)
        else:
